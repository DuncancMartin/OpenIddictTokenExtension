...
namespace OpenIddictTokenExtension.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordConfirmed = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    IsAdministrator = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    TenantAdministrator = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    Active = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    PasswordToken = table.Column<string>(type: "nvarchar(252)", maxLength: 252, nullable: true),
                    PasswordTokenExpiryTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedPermissionName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tokens_IdentityUsers_UserId",
                        column: x => x.UserId,
