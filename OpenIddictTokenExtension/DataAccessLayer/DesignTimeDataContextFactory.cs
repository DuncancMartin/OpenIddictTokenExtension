...
namespace OpenIddictTokenExtension.DataAccessLayer
{
    ...
    public class DesignTimeDataContextFactory : IDesignTimeDbContextFactory<IdentityDbContext>
    {
        ...
        public IdentityDbContext CreateDbContext(string[] args)
        {
            ...
            var connectionString = "Server=127.0.0.1,1402;Initial Catalog=Identity_DEV;Persist Security Info=False;User ID=sa;Password=TestPassword%1;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=True;Connection Timeout=30;";
